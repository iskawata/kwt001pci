...
define([
    ...
    'text!kwt001pci/test/pciCreateZZO/data/likert_triple/qti.xml'
     ...
     */
    pciTestProvider.addManifestPath('pciCreateZZO', 'kwt001pci/pciCreator/pciCreateZZO/pciCreator.json');
    ...
    QUnit.asyncTest('renders correctly', function (assert) {
        ...
        parseXml(likertTripleXml).then(function (itemData) {
            var assetManager = getAssetManager('/kwt001pci/views/js/test/pciCreateZZO/data/likert_triple/');
            var runner = qtiItemRunner('qti', itemData, {assetManager: assetManager})
                .on('render', function () {
                    ...
                    assert.equal($container.find('.qti-customInteraction .pciCreateZZO').length, 1, 'the container contains 3 likert interactions');
